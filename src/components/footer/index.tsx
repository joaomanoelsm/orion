            ...
            <div id="footer__container">
                    ...
                    <div id="footer__lists-container">
                        <div id="footer__list-about">
                            ...
                            <ul className="footer__lists">
                                ...
                                <li>
                                    <a href="#procedure">Planejamento</a>
                                </li>
                                <li>
                        ...
                        <div id="footer__list-politics">
                            ...
                            <ul className="footer__lists">
                                <li>
                                    <a onClick={() => nextPage('termos')}>
                                        Termos de uso
                                    </a>
                                </li>
                                <li>
                                    <a onClick={() => nextPage('privacidade')}>
                                        Política de privacidade
                                    </a>
                                </li>
                                <li>
                                    <a onClick={() => nextPage('cookies')}>
                                        Política de Cookies
                                    </a>
                                </li>
                            </ul>
                ...
                <div id="footer__copyright-container">
                    <span id="footer__copyright">
                        Copyright &copy; Orion - Todos os direitos reservados
                    </span>
                    <div id="footer__icons-container">
                        <a
                            target={'_blank'}
                            href="https://www.instagram.com/orionsld/?igshid=YWJhMjlhZTc%3D"
                        >
                            <img
