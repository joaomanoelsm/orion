    ...
    <section id='services' style={{ background: `url(${ ServicesBackground })`}}>
        <div className='services__container'>
            <div className='services__info'>
                <img className='services__icon' src={ OrionIcon } alt="ìcone da orion" />
                <h2 className='services__title'>O que solucionamos?</h2>
                <p className='services__text'>Principais áreas que atuamos e desenvolvemos para nossos clientes.</p>
            </div>
