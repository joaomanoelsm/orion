...
const WhyOrion = () => {
  return (
    <section id="whyOrion" style={{ background: `url(${ WhiteBackground })`}}>
        <div id="whyOrion__container">
            <div id="whyOrion__title-contain">
                <img id="whyOrion__icon" src={ ArrowIcon } alt="Decorador" />
                <h2 id="whyOrion__title">Por que seu <br /> negócio precisa da <br /> <span>Orion?</span></h2>
            </div>
            <div id="whyOrion__info">
