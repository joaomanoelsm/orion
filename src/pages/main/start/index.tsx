            ...
            <div className="start__container">
                <div className="start__info">
                    <h1 className="start__title">
                        Geramos <br /> soluções que viram <br /> resultados!
                    </h1>
                    <p className="start__text">
                        Pensamos e calculamos a melhor forma de estruturar e
                        crescer o seu négocio no meio digital, possuimos
                        profissionais qualificados que entregam resultados.
                    </p>
                    <a
                        target={'_blank'}
                        href="https://linker.fit/iIaLDbyxYhzHhcg"
                    >
                        <button className="start__button">Contato</button>
                    </a>
                </div>
