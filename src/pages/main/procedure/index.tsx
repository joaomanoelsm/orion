...
const Procedure = () => {
  return (
    <section id='procedure' style={{ background: `url(${ ProcedureBackground })`}}>
        <div id='procedure__container'>
            ...
            <div id='procedure__list-container'>
                <ul className='procedure__lists'>
                    <li><img src={ Icon1 } alt="Ícone" />Reunião para <br /> alinhamento</li>
                    <li><img src={ Icon2 } alt="Ícone" />Desenvolvimento <br /> da metodologia <br /> e estratégia de <br /> campanha</li>
                    <li><img src={ Icon3 } alt="Ícone" />Reunião para <br /> apresentação da <br /> estrátegia esco- <br /> lhida</li>
                </ul>
                ...
                <ul className='procedure__lists'>
                    <li><img src={ Icon4 } alt="Ícone" /><span>Gerenciamento <br /> do projeto</span></li>
                    <li><img src={ Icon5 } alt="Ícone" />Programação do <br /> material e ads <br /> nas plataformas</li>
                    <li><img src={ Icon6 } alt="Ícone" />Reunião final <br /> para baixas de <br /> resultados</li>
                </ul>
            </div>
        </div>
